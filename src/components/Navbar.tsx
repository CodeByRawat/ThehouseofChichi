...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? "bg-[#F5EFE6]/95 backdrop-blur-md shadow-sm py-4" : "bg-transparent py-6"}`}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed inset-0 bg-[#F5EFE6] z-50 p-6 flex flex-col overflow-y-auto"
          >
